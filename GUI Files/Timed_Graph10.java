...
public class Timed_Graph10 {
    ...
    */
    ...
    public static void display(String title, String message){
        ...
        Circle Circle1 = createCircle(430, 400, 15, Color.WHITE);
        Circle Circle2 = createCircle(240, 400, 15, Color.WHITE);
        Circle Circle3 = createCircle(300, 270, 15, Color.WHITE);
        Circle Circle4 = createCircle(430, 215, 15, Color.WHITE);
        Circle Circle5 = createCircle(560, 270, 15, Color.WHITE);
        Circle Circle6 = createCircle(615, 400, 15, Color.WHITE);
        Circle Circle7 = createCircle(565, 530, 15, Color.WHITE);
        Circle Circle8 = createCircle(430, 590, 15, Color.WHITE);
        Circle Circle9 = createCircle(295, 535, 15, Color.WHITE);
        Circle Circle10 = createCircle(130, 400, 15, Color.WHITE);
        Circle Circle11 = createCircle(220, 190, 15, Color.WHITE);
        Circle Circle12 = createCircle(430, 100, 15, Color.WHITE);
        Circle Circle13 = createCircle(640, 190, 15, Color.WHITE);
        Circle Circle14 = createCircle(730, 400, 15, Color.WHITE);
        Circle Circle15 = createCircle(640, 610, 15, Color.WHITE);
        Circle Circle16 = createCircle(430, 700, 15, Color.WHITE);
        Circle Circle17 = createCircle(215, 615, 15, Color.WHITE);
