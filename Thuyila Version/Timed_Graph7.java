...
public class Timed_Graph7 {
    ...
    */
    ...
    public static void display(String title, String message){
        ...
        Circle Circle1 = createCircle(425, 55, 15, Color.WHITE);
        Circle Circle2 = createCircle(100, 220, 15, Color.WHITE);
        Circle Circle3 = createCircle(425, 220, 15, Color.WHITE);
        Circle Circle4 = createCircle(760, 220, 15, Color.WHITE);
        Circle Circle5 = createCircle(425, 390, 15, Color.WHITE);
        Circle Circle6 = createCircle(100, 555, 15, Color.WHITE);
        Circle Circle7 = createCircle(425, 555, 15, Color.WHITE);
        Circle Circle8 = createCircle(760, 555, 15, Color.WHITE);
        Circle Circle9 = createCircle(425, 725, 15, Color.WHITE);
