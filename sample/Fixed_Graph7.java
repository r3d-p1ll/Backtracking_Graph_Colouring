...
public class Fixed_Graph7 {
	...
	public static void display(String title, String message){
		...
		Circle Circle1 = createCircle(145, 85, 15, Color.WHITE);
		Circle Circle2 = createCircle(389, 85, 15, Color.WHITE);
		Circle Circle3 = createCircle(660, 85, 15, Color.WHITE);
		Circle Circle4 = createCircle(389, 193, 15, Color.WHITE);
		Circle Circle5 = createCircle(337, 286, 15, Color.WHITE);
		Circle Circle6 = createCircle(440, 286, 15, Color.WHITE);
		Circle Circle7 = createCircle(235, 352, 15, Color.WHITE);
		Circle Circle8 = createCircle(543, 352, 15, Color.WHITE);
		Circle Circle9 = createCircle(389, 554, 15, Color.WHITE);
