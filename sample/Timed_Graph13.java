...
public class Timed_Graph13 {
    ...
    public static void display(String title, String message){
        ...
        Circle Circle4 = createCircle(600, 410, 15, Color.WHITE);
        Circle Circle5 = createCircle(425, 595, 15, Color.WHITE);
        Circle Circle6 = createCircle(90, 410, 15, Color.WHITE);
        Circle Circle7 = createCircle(90, 225, 15, Color.WHITE);
        Circle Circle8 = createCircle(90, 130, 15, Color.WHITE);
        Circle Circle9 = createCircle(135, 80, 15, Color.WHITE);
        Circle Circle10 = createCircle(245, 80, 15, Color.WHITE);
        Circle Circle11 = createCircle(425, 80, 15, Color.WHITE);
        Circle Circle12 = createCircle(600, 80, 15, Color.WHITE);
        Circle Circle13 = createCircle(700, 80, 15, Color.WHITE);
        Circle Circle14 = createCircle(755, 130, 15, Color.WHITE);
        Circle Circle15 = createCircle(755, 225, 15, Color.WHITE);
        Circle Circle16 = createCircle(755, 410, 15, Color.WHITE);
        Circle Circle17 = createCircle(755, 595, 15, Color.WHITE);
        Circle Circle18 = createCircle(755, 685, 15, Color.WHITE);
        Circle Circle19 = createCircle(700, 730, 15, Color.WHITE);
        Circle Circle20 = createCircle(600, 730, 15, Color.WHITE);
        Circle Circle21 = createCircle(425, 730, 15, Color.WHITE);
        Circle Circle22 = createCircle(245, 730, 15, Color.WHITE);
        Circle Circle23 = createCircle(135, 730, 15, Color.WHITE);
        Circle Circle24 = createCircle(90, 685, 15, Color.WHITE);
        Circle Circle25 = createCircle(90, 595, 15, Color.WHITE);
