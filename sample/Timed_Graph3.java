...
public class Timed_Graph3 {
    ...
    static final Integer starttime = 5; //edit how long the timer is from here.
    ...
    public static void display(String title, String message){
        ...
        Circle Circle1 = createCircle(75, 83, 15, Color.WHITE);
        Circle Circle2 = createCircle(310, 83, 15, Color.WHITE);
        Circle Circle3 = createCircle(310, 245, 15, Color.WHITE);
        Circle Circle4 = createCircle(75, 245, 15, Color.WHITE);
        Circle Circle5 = createCircle(210, 175, 15, Color.WHITE);
        Circle Circle6 = createCircle(440, 175, 15, Color.WHITE);
        Circle Circle7 = createCircle(440, 330, 15, Color.WHITE);
        Circle Circle8 = createCircle(210, 330, 15, Color.WHITE);
        Circle Circle9 = createCircle(365, 280, 15, Color.WHITE);
        Circle Circle10 = createCircle(570, 280, 15, Color.WHITE);
        Circle Circle11 = createCircle(570, 420, 15, Color.WHITE);
        Circle Circle12 = createCircle(365, 420, 15, Color.WHITE);
        Circle Circle13 = createCircle(510, 370, 15, Color.WHITE);
        Circle Circle14 = createCircle(700, 370, 15, Color.WHITE);
        Circle Circle15 = createCircle(700, 495, 15, Color.WHITE);
        Circle Circle16 = createCircle(510, 495, 15, Color.WHITE);
        Circle Circle17 = createCircle(635, 445, 15, Color.WHITE);
        Circle Circle18 = createCircle(790, 445, 15, Color.WHITE);
        Circle Circle19 = createCircle(790, 550, 15, Color.WHITE);
        Circle Circle20 = createCircle(635, 550, 15, Color.WHITE);
