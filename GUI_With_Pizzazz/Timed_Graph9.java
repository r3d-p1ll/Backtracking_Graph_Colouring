...
//                System.out.println(getNumColors());
    ...
    public static void display(String title, String message){
        ...
        //creating all circle objects of the Graph9
        Circle Circle1 = createCircle(420, 400, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(210, 400, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(420, 190, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(620, 400, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(420, 600, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(130, 400, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(130, 320, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(130, 110, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(340, 110, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(420, 110, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(500, 110, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(700, 110, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(700, 320, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(700, 400, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(700, 480, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(700, 680, 15, Color.WHITE,1);
        Circle Circle17 = createCircle(500, 680, 15, Color.WHITE,1);
        Circle Circle18 = createCircle(420, 680, 15, Color.WHITE,1);
        Circle Circle19 = createCircle(340, 680, 15, Color.WHITE,1);
        Circle Circle20 = createCircle(130, 680, 15, Color.WHITE,1);
        Circle Circle21 = createCircle(130, 480, 15, Color.WHITE,1);
        Circle Circle22 = createCircle(50, 400, 15, Color.WHITE,1);
        Circle Circle23 = createCircle(420, 30, 15, Color.WHITE,1);
        Circle Circle24 = createCircle(780, 400, 15, Color.WHITE,1);
        Circle Circle25 = createCircle(420, 760, 15, Color.WHITE,1);
