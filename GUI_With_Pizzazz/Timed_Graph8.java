...
//                System.out.println(getNumColors());
    ...
    public static void display(String title, String message){
        ...
        Circle Circle1 = createCircle(55, 55, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(330, 55, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(190, 200, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(55, 330, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(470, 200, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(330, 330, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(190, 475, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(605, 330, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(470, 467, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(330, 605, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(750, 467, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(605, 605, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(470, 750, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(750, 750, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(750, 55, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(55, 750, 15, Color.WHITE,1);
