...
//                System.out.println(getNumColors());
    ...
    public static void display(String title, String message){
        ...
        //creating all circle objects of the Graph10
        Circle Circle1 = createCircle(430, 400, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(240, 400, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(300, 270, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(430, 215, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(560, 270, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(615, 400, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(565, 530, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(430, 590, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(295, 535, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(130, 400, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(220, 190, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(430, 100, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(640, 190, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(730, 400, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(640, 610, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(430, 700, 15, Color.WHITE,1);
        Circle Circle17 = createCircle(215, 615, 15, Color.WHITE,1);
