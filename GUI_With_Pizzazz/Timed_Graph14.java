...
//                System.out.println(getNumColors());
    ...
    public static void display(String title, String message){
        ...
        Circle Circle1 = createCircle(360, 355, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(480, 355, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(520, 480, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(420, 550, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(320, 480, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(200, 480, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(165, 355, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(260, 280, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(320, 235, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(420, 160, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(515, 230, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(580, 280, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(680, 355, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(640, 480, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(615, 550, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(580, 670, 15, Color.WHITE,1);
        Circle Circle17 = createCircle(460, 675, 15, Color.WHITE,1);
        Circle Circle18 = createCircle(380, 675, 15, Color.WHITE,1);
        Circle Circle19 = createCircle(260, 670, 15, Color.WHITE,1);
        Circle Circle20 = createCircle(225, 550, 15, Color.WHITE,1);
        Circle Circle21 = createCircle(70, 325, 15, Color.WHITE,1);
        Circle Circle22 = createCircle(425, 55, 15, Color.WHITE,1);
        Circle Circle23 = createCircle(780, 325, 15, Color.WHITE,1);
        Circle Circle24 = createCircle(650, 765, 15, Color.WHITE,1);
        Circle Circle25 = createCircle(200, 765, 15, Color.WHITE,1);
