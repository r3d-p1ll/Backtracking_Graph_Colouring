...
*@method method setGameOver() sets the gameover window with timer
*@method doTime() keeps record of the time
*@method dispaly() displays the graph
 */
...
public class Timed_Graph1 {
    ...
    //@asem Just add the Integer colorAttached and change circle.setOnMousePressed.  Also add the to instance variable underneath the hint comment on top
    ...
    public static void display(String title, String message){
        ...
        //creating all circle objects of the Graph1
        Circle Circle1 = createCircle(564, 285, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(576, 80, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(304, 705, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(564, 515, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(576, 705, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(304, 80, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(220, 280, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(642, 280, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(304, 515, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(220, 518, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(433, 634, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(304, 285, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(642, 518, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(433, 398, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(433, 161, 15, Color.WHITE,1);
