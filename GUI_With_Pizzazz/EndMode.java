...
public class EndMode  {
    private static Stage finish = new Stage();
    public static void display(){
        ...
        if(Random_Graphs.getNumColors() > Backtracking_Alg.getChromNumber()){
            ...
            Text c = new Text("Sorry, this isn't the minimum amount of colors you can use.\n" +
                    "Try to use less the next time." );
        ...
        Scene scene = new Scene(layout3, 500, 70);
