...
//                System.out.println(getNumColors());
    ...
    public static void display(String title, String message){
        ...
        //creating all circle objects of the Graph15
        Circle Circle1 = createCircle(430, 425, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(330, 425, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(280, 340, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(380, 345, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(430, 255, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(480, 345, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(575, 345, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(525, 425, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(570, 510, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(480, 510, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(430, 600, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(375, 510, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(280, 510, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(255, 425, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(175, 285, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(340, 285, 15, Color.WHITE,1);
        Circle Circle17 = createCircle(430, 140, 15, Color.WHITE,1);
        Circle Circle18 = createCircle(520, 285, 15, Color.WHITE,1);
        Circle Circle19 = createCircle(685, 285, 15, Color.WHITE,1);
        Circle Circle20 = createCircle(600, 425, 15, Color.WHITE,1);
        Circle Circle21 = createCircle(685, 565, 15, Color.WHITE,1);
        Circle Circle22 = createCircle(520, 565, 15, Color.WHITE,1);
        Circle Circle23 = createCircle(430, 705, 15, Color.WHITE,1);
        Circle Circle24 = createCircle(335, 565, 15, Color.WHITE,1);
        Circle Circle25 = createCircle(175, 565, 15, Color.WHITE,1);
        Circle Circle26 = createCircle(185, 425, 15, Color.WHITE,1);
        Circle Circle27 = createCircle(65, 230, 15, Color.WHITE,1);
        Circle Circle28 = createCircle(300, 230, 15, Color.WHITE,1);
        Circle Circle29 = createCircle(430, 45, 15, Color.WHITE,1);
        Circle Circle30 = createCircle(560, 230, 15, Color.WHITE,1);
        Circle Circle31 = createCircle(795, 230, 15, Color.WHITE,1);
        Circle Circle32 = createCircle(675, 425, 15, Color.WHITE,1);
        Circle Circle33 = createCircle(790, 610, 15, Color.WHITE,1);
        Circle Circle34 = createCircle(555, 610, 15, Color.WHITE,1);
        Circle Circle35 = createCircle(430, 795, 15, Color.WHITE,1);
        Circle Circle36 = createCircle(300, 610, 15, Color.WHITE,1);
        Circle Circle37 = createCircle(65, 610, 15, Color.WHITE,1);
