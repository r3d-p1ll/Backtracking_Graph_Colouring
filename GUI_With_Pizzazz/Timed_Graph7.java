...
public class Timed_Graph7 {
    ...
    public static void display(String title, String message){
         ...
         */
        Circle Circle1 = createCircle(425, 55, 15, Color.TRANSPARENT,1);
        Circle Circle2 = createCircle(100, 220, 15, Color.TRANSPARENT,1);
        Circle Circle3 = createCircle(425, 220, 15, Color.TRANSPARENT,1);
        Circle Circle4 = createCircle(760, 220, 15, Color.TRANSPARENT,1);
        Circle Circle5 = createCircle(425, 390, 15, Color.TRANSPARENT,1);
        Circle Circle6 = createCircle(100, 555, 15, Color.TRANSPARENT,1);
        Circle Circle7 = createCircle(425, 555, 15, Color.TRANSPARENT,1);
        Circle Circle8 = createCircle(760, 555, 15, Color.TRANSPARENT,1);
        Circle Circle9 = createCircle(425, 725, 15, Color.TRANSPARENT,1);
