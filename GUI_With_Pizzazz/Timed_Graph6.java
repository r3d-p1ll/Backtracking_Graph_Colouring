...
/*class Time_Graph6 to display a graph, by circles and lines,
run the time,
...
and to create a game with graph6
...
//                System.out.println(getNumColors());
    ...
    *@param message message printed to the user
    ...
    public static void display(String title, String message){
        ...
        //Adding HINTS button
        Label buttonhint = new Label("Double click a vertice for hint");
...
//        buttonhint.setOnAction(e ->  Hinter());
        ...
        //creating all circle objects of the Graph6
        Circle Circle1 = createCircle(445, 410, 15, Color.WHITE,1);
        Circle Circle2 = createCircle(310, 410, 15, Color.WHITE,1);
        Circle Circle3 = createCircle(310, 240, 15, Color.WHITE,1);
        Circle Circle4 = createCircle(445, 240, 15, Color.WHITE,1);
        Circle Circle5 = createCircle(575, 240, 15, Color.WHITE,1);
        Circle Circle6 = createCircle(575, 410, 15, Color.WHITE,1);
        Circle Circle7 = createCircle(575, 575, 15, Color.WHITE,1);
        Circle Circle8 = createCircle(445, 575, 15, Color.WHITE,1);
        Circle Circle9 = createCircle(310, 575, 15, Color.WHITE,1);
        Circle Circle10 = createCircle(190, 410, 15, Color.WHITE,1);
        Circle Circle11 = createCircle(445, 70, 15, Color.WHITE,1);
        Circle Circle12 = createCircle(700, 410, 15, Color.WHITE,1);
        Circle Circle13 = createCircle(445, 740, 15, Color.WHITE,1);
        Circle Circle14 = createCircle(70, 240, 15, Color.WHITE,1);
        Circle Circle15 = createCircle(820, 240, 15, Color.WHITE,1);
        Circle Circle16 = createCircle(820, 575, 15, Color.WHITE,1);
        Circle Circle17 = createCircle(70, 575, 15, Color.WHITE,1);
